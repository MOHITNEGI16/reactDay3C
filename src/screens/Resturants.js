...
function Resturants() {
  ...
  const rawData = [
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b35" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b36" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b37" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b38" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b39" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b3a" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b3c" },
    ...
    {
      URL: "http://www.just-eat.co.uk/restaurants-1stclasspizza-bs7/menu",
      _id: { $oid: "55f14312c7447c3da7051b3d" },
      address: "388 Filton Avenue",
      "address line 2": "Bristol",
      name: "1st Class Pizza",
      outcode: "BS7",
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b3e" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b3f" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b40" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b41" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b42" },
    ...
    },
    {
      ...
      _id: { $oid: "55f14312c7447c3da7051b43" },
  ...
  function handleResturantChange(e) {
    setResturant(e.target.value);

    filtersDataCharacter(e.target.value);
  }

  function filtersDataCharacter(char) {
    console.log(char);
    const charArray = char.split("");
    console.log(charArray);

    const filterData = rawData.filter((ele) => {
      return charArray.every((char) => ele.name.includes(char));
    });
  ...
  function handleRatingChange(e) {
    if (parseInt(e.target.value) > 6 || parseInt(e.target.value) < 0) {
      alert("rating is from 0 to 6");
    }
    ...
    if (parseInt(e.target.value) === 0) {
      ...
      const filterRating = rawData.filter(
        (ele) => ele.rating >= parseInt(e.target.value)
      );
      filterRating.sort((a, b) => b.rating - a.rating);

      setData(filterRating);
    }
  }
